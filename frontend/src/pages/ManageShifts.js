...
export default function ManageShifts() {
  ...
  const handleBulkSubmit = async () => {
    ...
    setSaving(true);
    try {
      const r = await axios.post('/api/shifts/bulk', { user_ids:bulk.selected_users, dates, start_time:bulk.start_time, end_time:bulk.end_time, notes:bulk.notes, status:bulk.status });
