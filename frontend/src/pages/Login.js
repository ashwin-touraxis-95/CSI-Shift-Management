        ...
        <div style={{ background:cardBg, borderRadius:16, padding:32, border:'1px solid rgba(255,255,255,0.08)' }}>
          ...
          {setupMode ? (
            <form onSubmit={handleSetupPassword}>
              ...
              <button type="submit" disabled={loading} style={{ width:'100%',padding:13,borderRadius:10,background:primary,color:'white',border:'none',fontSize:15,fontWeight:700,cursor:'pointer',fontFamily:'inherit',opacity:loading?0.7:1 }}>
        ...
        {showForgot && (
          <div style={{ position:'fixed',top:0,left:0,right:0,bottom:0,background:'rgba(0,0,0,0.7)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000,padding:20 }}>
            <div style={{ background:'#1E293B',borderRadius:16,padding:32,maxWidth:380,width:'100%',border:'1px solid rgba(255,255,255,0.08)' }}>
              ...
              <button onClick={()=>setShowForgot(false)} style={{ width:'100%',padding:12,borderRadius:10,background:primary,color:'white',border:'none',fontSize:14,fontWeight:700,cursor:'pointer',fontFamily:'inherit' }}>
                Got it
              </button>
            </div>
          </div>
