...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ user, permissions, theme, loading, login, logout, can, isAdmin, isManager, isLeader, needsOnboarding, updateTheme, updateUser, sessionExpired, clearSessionExpired: () => setSessionExpired(false) }}>
      {children}
