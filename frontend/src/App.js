...
import HoursTracker from './pages/HoursTracker';
import AdminPanel from './pages/AdminPanel';
import Display from './pages/Display';
import EmbedDaily from './pages/EmbedDaily';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/manage-shifts" element={<Navigate to="/schedule" />} />
      <Route path="/team" element={<PrivateRoute><Team /></PrivateRoute>} />
      <Route path="/profile" element={<PrivateRoute><Profile /></PrivateRoute>} />
      <Route path="/leave" element={<Navigate to="/schedule" />} />
      <Route path="/hours" element={<PrivateRoute requireUserType={['account_admin','manager','team_leader']}><HoursTracker /></PrivateRoute>} />
      <Route path="/display" element={<Display />} />
      <Route path="/embed/daily" element={<EmbedDaily />} />
      <Route path="/preview" element={<PrivateRoute requireUserType={['account_admin']}><Preview /></PrivateRoute>} />
