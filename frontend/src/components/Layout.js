...
export default function Layout({ children }) {
  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh' }}>
      ...
      <main style={{ marginLeft: sidebarW, flex:1, padding:'28px 32px', minHeight:'100vh', background:'var(--app-bg,#F1F5F9)', transition:'margin-left 0.2s ease', minWidth:0, overflowX:'hidden', boxSizing:'border-box' }}>
