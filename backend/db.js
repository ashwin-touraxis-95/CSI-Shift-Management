...
const DEFAULT_THEME = {
  ...
  footer_line1: 'ShiftManager v13', footer_line2: 'Built by Ashwin Halford', footer_line3: '',
};
...
async function initDb() {
  ...
  // Fix any break_types that have null active (should be 1)
  try { await query("UPDATE break_types SET active=1 WHERE active IS NULL"); } catch(e) {}
  // Ensure break_types active column has correct default
  ...
  console.log('✅ ShiftManager v13 database ready');
}
